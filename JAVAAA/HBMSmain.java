...
public static Connection connectDB() throws SQLException {
    String url = "jdbc:mysql://127.0.0.1:3306/hbms_project";
    String user = "root";
...
public static void patientportal() {
    ...
    bigNumber.setFont(new Font("Arial", Font.BOLD, 120));
    ...
    if (currentBeds > 0) {
        ...
        int newVacant = getLiveVacancy(selectedRoom);
        bigNumber.setText(String.valueOf(newVacant));
    } else {
